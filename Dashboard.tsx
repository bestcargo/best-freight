          ...
          >
            ...
            <form onSubmit={(e) => {
              ...
              if (editingTransactionId) {
                ...
                updateDoc(doc(db, 'transactions', editingTransactionId), updatedData)
                  .catch(err => {
                    handleFirestoreError(err, 'update', `transactions/${editingTransactionId}`);
                  });
              } else {
                const newT = {
                  ...data,
                ...
                addDoc(collection(db, 'transactions'), newT)
                  .catch(err => {
